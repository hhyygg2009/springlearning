    ...
    <aside id="sidebar" class="affix">
        ...
        <div id="sidebar-menu">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="category_list.html"><span class="glyphicons glyphicon-credit-card"></span><span
                                    ...
                                    <c:forEach items="${majors}" var="major">
                                        ...
                                        <tr class="success">
                                            <td class="text-center">
                                                <input type="checkbox" value="${major.major_id}" name="idarr[]"
                                                       class="cbox"></td>
                                            <td>${major.major_name}</td>
                                            <td>${major.tuition}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="update?id=${major.major_id}" class="btn btn-default btn-gradient"><span
                                                            class="glyphicons glyphicon-pencil"></span></a>
                                                    <a onclick="return confirm('确定要删除吗？');" href="delete?id=${major.major_id}"
